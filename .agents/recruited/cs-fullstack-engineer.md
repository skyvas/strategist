...
Agent ID    : cs-fullstack-engineer
Title       : Fullstack Rapid Prototyper
Domain      : engineering
Loop Target : Loop 3 (TDD Implementation Loop)
Upstream    : cs-engineering-lead
Downstream  : test-architect, karpathy-reviewer
Loop Peers  : cs-senior-engineer
Source Repo : https://raw.githubusercontent.com/alirezarezvani/claude-skills/main/docs/agents/cs-fullstack-engineer.md
-->
