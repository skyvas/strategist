...
Domain      : devops
Loop Target : Loop 5 (Runtime, Security & Infrastructure)
Upstream    : karpathy-reviewer, cs-senior-engineer
Downstream  : hub-coordinator, Production Deployment
Loop Peers  : cs-backend-engineer, hub-coordinator
Source Repo : https://raw.githubusercontent.com/alirezarezvani/claude-skills/main/docs/agents/devops-engineer.md
-->
