...
Agent ID    : cs-frontend-engineer
Title       : Frontend Engineering Orchestrator (UI/UX, Mobile, Tablet)
Domain      : engineering
Loop Target : Loop 3 (TDD Implementation Loop) & Loop 4 (Code Quality)
Upstream    : cs-engineering-lead, test-architect
Downstream  : test-debugger, karpathy-reviewer
Loop Peers  : cs-backend-engineer, test-architect, karpathy-reviewer
Source Repo : https://raw.githubusercontent.com/alirezarezvani/claude-skills/main/docs/agents/cs-frontend-engineer.md
-->
