...
Agent ID    : cs-handoff-author
Title       : Context Compaction & Shift Handoff Author
Domain      : productivity
Loop Target : Continuity & Handoff Loop
Upstream    : hub-coordinator, Context Manager
Downstream  : Next Agent / Next Shift Lead
Loop Peers  : Context Manager
Source Repo : https://raw.githubusercontent.com/alirezarezvani/claude-skills/main/docs/agents/cs-handoff-author.md
-->
