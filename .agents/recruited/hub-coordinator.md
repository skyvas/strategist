...
Agent ID    : hub-coordinator
Title       : AgentHub Multi-Agent Swarm Coordinator
Domain      : orchestration
Loop Target : Orchestration & Convergence Governor
Upstream    : Recruiter / Chief Org Manager, devops-engineer
Downstream  : All Swarm Workers, cs-handoff-author
Loop Peers  : Recruiter / Chief Org Manager
Source Repo : https://raw.githubusercontent.com/alirezarezvani/claude-skills/main/docs/agents/hub-coordinator.md
-->
