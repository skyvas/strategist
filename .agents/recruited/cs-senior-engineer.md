...
Agent ID    : cs-senior-engineer
Title       : Senior Staff Engineer (Patterns & Resilience)
Domain      : engineering
Loop Target : Loop 4 (Code Quality & Review)
Upstream    : cs-frontend-engineer, cs-backend-engineer
Downstream  : devops-engineer, hub-coordinator
Loop Peers  : karpathy-reviewer, cs-engineering-lead
Source Repo : https://raw.githubusercontent.com/alirezarezvani/claude-skills/main/docs/agents/cs-senior-engineer.md
-->
